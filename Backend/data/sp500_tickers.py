SP500_TICKERS = [
    ...
    'BKNG', 'BKR', 'BLDR', 'BMY', 'BR', 'BRK-B', 'BRO', 'BSX', 'BWA', 'BX',
    ...
    'GIS', 'GL', 'GLW', 'GM', 'GNRC', 'GOOGL', 'GPC', 'GPN', 'GRMN', 'GS',
    ...
    'META', 'MHK', 'MKC', 'MKTX', 'MLM', 'MMC', 'MMM', 'MNST', 'MO', 'MOH',
    ...
    'SCHW', 'SHW', 'SJM', 'SLB', 'SNA', 'SNPS', 'SO', 'SOLV', 'SPG', 'SPGI',
...
CRYPTO_TICKERS = [
    ...
    'LTC-USD', 'MATIC-USD', 'SHIB-USD', 'TRX-USD', 'UNI-USD',
